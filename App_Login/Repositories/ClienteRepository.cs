    ...
    public class ClienteRepository : IClienteRepository
    {
        ...
        public void Atualizar(Cliente cliente)
        {
            ...
            using (var conexao = new MySqlConnection(_conexao))
            {
                ...
                MySqlCommand cmd = new MySqlCommand("update Cliente set (Nome = @Nome, Nascimento = @Nascimento, Sexo = @Sexo, CPF = @CPF" + "Telefone = @Telefone, Email = @Email, Senha = @Senha, Situacao = @Situacao", conexao);
